 ...
 */
public class AndrewRobinetteQuest10CommandExecutor implements CommandExecutor {
	private final AndrewRobinetteQuest10 plugin;
	 ...
	 * from
	 */
	public AndrewRobinetteQuest10CommandExecutor(AndrewRobinetteQuest10 plugin) {
		this.plugin = plugin;
	}
	...
	public boolean onCommand(CommandSender sender, Command command,
		...
		if (!(sender instanceof Player)) {
			...
			testBlock = new GrayBlock(plugin);
			Player player = (Player) sender;
